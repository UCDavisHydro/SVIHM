...
for /L %%i in (1,1,6) do (  
  ...
  copy UCODE\UCODE_Input_Files\SVIHM_Sensitivity_2.txt Sensitivity_2\Runner%%i\SVIHM_Sensitivity_2.txt
...
"C:\wrdapp\UCODE_2014_1.004_and_more\UCODE_2014_1.004\bin\residual_analysis.exe" SVIHM_Sensitivity_2_out 
pause
