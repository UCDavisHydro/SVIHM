...
!    write(536,*)
  ...
  !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  subroutine write_MODFLOW_WEL_depletion(im,imonth,total_n_wells,n_wel_param,WELL_LAY, WELL_ROW, WELL_COL,WELL_OUT_RATE)
  
  INTEGER             :: im, imonth, total_n_wells, n_wel_param, iwell
  INTEGER, INTENT(in) :: WELL_LAY, WELL_ROW, WELL_COL
  REAL, INTENT(in)    :: WELL_OUT_RATE
...
!    write(536,*)
  ...
  if (imonth == 7) then                                                             ! If April apply half the pumping rate since it doesn't start until the 15th
    write(536,'(3I10,ES15.3)') WELL_LAY, WELL_ROW, WELL_COL, WELL_OUT_RATE/2       
  else if (imonth .GE. 8 .and. imonth .LE. 11) then                                 ! If May - August apply full pumping rate
  	write(536,'(3I10,ES15.3)') WELL_LAY, WELL_ROW, WELL_COL, WELL_OUT_RATE       
  ...
  end subroutine  write_MODFLOW_WEL_depletion
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    subroutine write_MODFLOW_RCH(im,imonth,nday,nrows,ncols,output_zone_matrix, DEP_ACR_FLAG, WELL_ROW, WELL_COL, RCH_IN_RATE)  

      INTEGER, INTENT(IN) :: im,imonth,nrows,ncols, DEP_ACR_FLAG, WELL_ROW, WELL_COL
      INTEGER, INTENT(IN) :: output_zone_matrix(nrows,ncols), nday(0:11)
      REAL, ALLOCATABLE, DIMENSION(:,:) ::  recharge_matrix
      REAL, INTENT(IN)    :: RCH_IN_RATE
      INTEGER :: ip
      REAL :: ttl_rch, linear_rch
      ...
      if (DEP_ACR_FLAG==1 .and. imonth .GE. 4 .and. imonth .LE. 9) then                              ! If January - June
        linear_rch = RCH_IN_RATE/10000.0                                                              ! Convert recharge rate from m^3/day to m/day (100m x 100m grid cells)
        recharge_matrix(WELL_ROW, WELL_COL) = recharge_matrix(WELL_ROW, WELL_COL) + linear_rch      ! Add linear recharge rate to cells
      end if
