...
Streamflow_Monthly_m3$WY = rep(seq(1991,2011), each = 12)
...
MODFLOW_Annual_m3$Water_Year = rep(seq(1991,2011),each = 12)
...
MODFLOW_Annual_Budget_Mm3_Plot = ggplot(MODFLOW_Annual_m3_Plotting_melt, aes(x = `Water Year`, y = value/1E6)) +
    geom_bar(aes(fill = variable), position = "stack", stat = 'identity', color = 'black', width = 0.95, size = 0.1) +
    scale_x_continuous(limits = c(1990.4,2011.6), breaks = seq(1991,2011,by = 2),expand = c(0,0))  +
...
if (fig_format == 'jpg'){
  jpeg(paste0(out_dir,fig_name,'.jpg'), width = 9, height = 6.75, units = 'in',  res = 600)
} else if (fig_format == 'png'){
  png(paste0(out_dir,fig_name,'.png'), width = 9, height = 6.75, units = 'in',  res = 600)
} else if (fig_format == 'pdf'){
  pdf(paste0(out_dir,fig_name,'.pdf'), width = 9, height = 6.75)
}
grid.newpage()
...
print(Streamflow_Annual_TAF_Plot +
        scale_y_continuous(limits = c(-800,800), breaks = seq(-800,800,by = 200), expand = c(0,0)) +
        geom_rect(aes(xmin = 1990.5, xmax = 1992.5, ymin = -800 , ymax = -725), fill = '#ff8282', color = 'black', size = 0.2) +
        geom_rect(aes(xmin = 1993.5, xmax = 1994.5, ymin = -800 , ymax = -725), fill = '#ff8282', color = 'black', size = 0.2) +
        geom_rect(aes(xmin = 1994.5, xmax = 1999.5, ymin = -800 , ymax = -725), fill = 'skyblue', color = 'black', size = 0.2) +
        geom_rect(aes(xmin = 2000.5, xmax = 2002.5, ymin = -800 , ymax = -725), fill = '#ff8282', color = 'black', size = 0.2) +
        geom_rect(aes(xmin = 2005.5, xmax = 2006.5, ymin = -800 , ymax = -725), fill = 'skyblue', color = 'black', size = 0.2) +
        geom_rect(aes(xmin = 2006.5, xmax = 2009.5, ymin = -800 , ymax = -725), fill = '#ff8282', color = 'black', size = 0.2) +
        geom_rect(aes(xmin = 2010.5, xmax = 2011.5, ymin = -800 , ymax = -725), fill = 'skyblue', color = 'black', size = 0.2) +
        theme(axis.text.x = element_blank(),
              plot.title = element_blank(),
              axis.title.y = element_text(size = 8),
              ...
              legend.text = element_text(size = 6, margin = margin(r=1,l=1, unit = 'pt')),
              legend.position = c(0.38,0.94))+ 
        annotate('text', x = 1991.5, y = -762.5, label = 'Dry', size = 1.4) +
        annotate('text', x = 1994, y = -762.5, label = 'Dry', size = 1.4) +
        annotate('text', x = 1997, y = -762.5, label = 'Wet', size = 1.4) +
        annotate('text', x = 2001.5, y = -762.5, label = 'Dry', size = 1.4) +
        annotate('text', x = 2006, y = -762.5, label = 'Wet', size = 1.4) +
        annotate('text', x = 2008, y = -762.5, label = 'Dry', size = 1.4) +
        annotate('text', x = 2011, y = -762.5, label = 'Wet', size = 1.4),
      vp = vplayout(1,1))
print(SWBM_Annual_TAF_Plot + 
        ...
        theme(axis.text.x = element_blank(),
              axis.title.y = element_text(size = 8),
              plot.title = element_blank(),
              plot.margin = margin(t=5, b=5,l=8, r=3),
              legend.key.height = unit(3,'pt'),
              legend.key.width = unit(6, 'pt'),
              legend.text = element_text(size = 6, margin = margin(r=1,l=1, unit = 'pt')),
...
Streamflow_Avg_2010_Mm3_Plot =  ggplot(Streamflow_Monthly_m3_melt, aes(x = Month, y = value/1E6)) + 
  geom_bar(data = subset(Streamflow_Monthly_m3_melt, format(Date,format='%Y')==2010),
           aes(fill = variable), position = "stack", stat = 'identity', color = 'black', width = 0.95, size = 0.1) +
  scale_fill_manual(values = Streamflow_colors, labels = Streamflow_flux_labels) +
...
Streamflow_Wet_2006_Mm3_Plot =  ggplot(Streamflow_Monthly_m3_melt, aes(x = Month, y = value/1E6)) + 
  geom_bar(data = subset(Streamflow_Monthly_m3_melt, format(Date,format='%Y')==2006),
           aes(fill = variable), position = "stack", stat = 'identity', color = 'black', width = 0.95, size = 0.1) +
  scale_fill_manual(values = Streamflow_colors, labels = Streamflow_flux_labels) +
...
Streamflow_Avg_2010_TAF_Plot =  ggplot(Streamflow_Monthly_m3_melt, aes(x = Month, y = value*0.000000810714)) +  #conversion from m3 to TAF
  geom_bar(data = subset(Streamflow_Monthly_m3_melt, format(Date,format='%Y')==2010),
           aes(fill = variable), position = "stack", stat = 'identity', color = 'black', width = 0.95, size = 0.1) +
  scale_fill_manual(values = Streamflow_colors, labels = Streamflow_flux_labels) +
  scale_y_continuous(limits = c(-80,80), breaks = seq(-80,80,by = 20),expand = c(0,0)) +
...
Streamflow_Wet_2006_TAF_Plot =  ggplot(Streamflow_Monthly_m3_melt, aes(x = Month, y = value*0.000000810714)) +  #conversion from m3 to TAF
  geom_bar(data = subset(Streamflow_Monthly_m3_melt, format(Date,format='%Y')==2006),
           aes(fill = variable), position = "stack", stat = 'identity', color = 'black', width = 0.95, size = 0.1) +
  scale_fill_manual(values = Streamflow_colors, labels = Streamflow_flux_labels) +
  scale_y_continuous(limits = c(-200,200), breaks = seq(-200,200,by = 50),expand = c(0,0)) +
...
if (fig_format == 'jpg'){
  jpeg(paste0(out_dir,fig_name,'.jpg'), width = 9.5, height = 6.75, units = 'in',  res = 600)
} else if (fig_format == 'png'){
  png(paste0(out_dir,fig_name,'.png'), width = 9.5, height = 6.75, units = 'in',  res = 600)
} else if (fig_format == 'pdf'){
  pdf(paste0(out_dir,fig_name,'.pdf'), width = 9.5, height = 6.75)
}
grid.newpage()
pushViewport(viewport(layout = grid.layout(3,3)))
vplayout <- function(x, y) viewport(layout.pos.row = x, layout.pos.col = y)
print(Streamflow_Dry_2001_TAF_Plot + 
        scale_y_continuous(limits = c(-160,160), breaks = seq(-160,160,by = 40), expand = c(0,0)) +
        theme(axis.title.y = element_text(size =10),
              ...
              legend.key.height = unit(2.5,'pt'),
              legend.key.width = unit(5, 'pt'),
              legend.text = element_text(size = 6.5, margin = margin(r=1,l=1, unit = 'pt')),
              legend.position = c(0.5,0.90)) +
        annotate('text', x = 10, y = -120, label = 'Surface Water\nDry Year\n(2001)', size = 2.4),
      vp = vplayout(1,1))
print(SWBM_Dry_Year_2001_TAF_Plot + 
        ...
        theme(axis.text.x = element_blank(),
              ...
              legend.text = element_text(size = 6.5, margin = margin(r=1,l=1, unit = 'pt')),
              legend.position = c(0.5,0.90)) +
        annotate('text', x = 10, y = -120, label = 'Soil Zone\nDry Year\n(2001)', size = 2.4),
      vp = vplayout(2,1))
print(MODFLOW_Dry_Year_2001_TAF_Plot + 
        ...
        theme(axis.title.y = element_text(size =10),
              ...
              legend.text = element_text(size = 6.5, margin = margin(r=1,l=1, unit = 'pt')),
              legend.position = c(0.5,0.90)) +
        annotate('text', x = 10, y = -120, label = 'Aquifer\nDry Year\n(2001)', size = 2.4),
      vp = vplayout(3,1))
...
SWBM_Budget_Precip_Dry_Avg_Wet = rbind(subset(SWBM_Monthly_m3, WY=='2001', select = c('Month', 'Precipitation','WY')),
...
SWBM_Budget_Precip_Dry_Avg_Wet$Month = substr(SWBM_Budget_Precip_Dry_Avg_Wet$Month,1,nchar(SWBM_Budget_Precip_Dry_Avg_Wet$Month)-5)

#SWBM_Budget_Precip_Dry_Avg_Wet$WY = factor(SWBM_Budget_Precip_Dry_Avg_Wet$WY, levels = c('2001','2010','2006'))
SWBM_Budget_Precip_Dry_Avg_Wet$Month = factor(SWBM_Budget_Precip_Dry_Avg_Wet$Month, levels = c('Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep'))
SWBM_Budget_Precip_Dry_Avg_Wet = SWBM_Budget_Precip_Dry_Avg_Wet[order(SWBM_Budget_Precip_Dry_Avg_Wet$Month),]
SWBM_Budget_Precip_Dry_Avg_Wet$WY = as.character(SWBM_Budget_Precip_Dry_Avg_Wet$WY)

(Monthly_Precip_Dry_Avg_Wet_Plot = ggplot(SWBM_Budget_Precip_Dry_Avg_Wet, aes(x = Month, y = Precipitation/1E6)) + 
...
# Recharge -----------------------------------------------------------
MODFLOW_Budget_Recharge_Dry_Avg_Wet = rbind(subset(MODFLOW_Monthly_m3,Water_Year=='2001', select = c('Month', 'RECHARGE_in_m3', 'Water_Year')),
...
MODFLOW_Budget_Recharge_Dry_Avg_Wet$Month = factor(MODFLOW_Budget_Recharge_Dry_Avg_Wet$Month, levels = c('Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep'))
MODFLOW_Budget_Recharge_Dry_Avg_Wet = MODFLOW_Budget_Recharge_Dry_Avg_Wet[order(MODFLOW_Budget_Recharge_Dry_Avg_Wet$Month),]
MODFLOW_Budget_Recharge_Dry_Avg_Wet$Water_Year = as.character(MODFLOW_Budget_Recharge_Dry_Avg_Wet$Water_Year)

(Monthly_Recharge_Dry_Avg_Wet_Plot = ggplot(MODFLOW_Budget_Recharge_Dry_Avg_Wet, aes(x = Month, y = RECHARGE_in_m3/1E6)) + 
...
# Groundwater Pumping -----------------------------------------------------------
MODFLOW_Budget_Pumping_Dry_Avg_Wet = rbind(subset(MODFLOW_Monthly_m3,Water_Year=='2001', select = c('Month', 'WELLS_out_m3', 'Water_Year')),
...
MODFLOW_Budget_Pumping_Dry_Avg_Wet$Month = factor(MODFLOW_Budget_Pumping_Dry_Avg_Wet$Month, levels = c('Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep'))
MODFLOW_Budget_Pumping_Dry_Avg_Wet = MODFLOW_Budget_Pumping_Dry_Avg_Wet[order(MODFLOW_Budget_Pumping_Dry_Avg_Wet$Month),]
MODFLOW_Budget_Pumping_Dry_Avg_Wet$Water_Year = as.character(MODFLOW_Budget_Pumping_Dry_Avg_Wet$Water_Year)

(Monthly_Pumping_Dry_Avg_Wet_Plot = ggplot(MODFLOW_Budget_Pumping_Dry_Avg_Wet, aes(x = Month, y = WELLS_out_m3/1E6)) + 
...
# Net Stream-Aquifer Flux -----------------------------------------------------------
MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet = rbind(subset(MODFLOW_Monthly_m3,Water_Year=='2001', select = c('Month', 'STREAM_LEAKAGE_net_m3', 'Water_Year')),
...
MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet$Month = factor(MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet$Month, levels = c('Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep'))
MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet = MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet[order(MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet$Month),]
MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet$Water_Year = as.character(MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet$Water_Year)

(Monthly_GW_SW_Flux_Dry_Avg_Wet_Plot = ggplot(MODFLOW_Budget_GW_SW_Flux_Dry_Avg_Wet, aes(x = Month, y = STREAM_LEAKAGE_net_m3/1E6)) + 
    ...
    scale_color_manual(breaks = c('2001', '2010', '2006'), values = c('Red', 'Blue', 'springgreen4'), labels = c('Dry (2001)', 'Average (2010)', 'Wet (2006)')) +
    xlab('') +
    ylab(bquote('Net Stream-Aquifer Flux ('*Mm^3*')')) +
...
# Relative Storage -----------------------------------------------------------
MODFLOW_Relative_Storage = subset(MODFLOW_Monthly_m3, select = c('Month', 'Water_Year'))
MODFLOW_Relative_Storage$Relative_Storage_m3 = cumsum(MODFLOW_Monthly_m3$STORAGE_net_m3) - MODFLOW_Monthly_m3$STORAGE_net_m3[1]

MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet = rbind(subset(MODFLOW_Relative_Storage,Water_Year=='2001'),
                                              subset(MODFLOW_Relative_Storage,Water_Year=='2010'),
                                              subset(MODFLOW_Relative_Storage,Water_Year=='2006'))

MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet$Month = factor(MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet$Month, levels = c('Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep'))
MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet = MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet[order(MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet$Month),]
MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet$Water_Year = as.character(MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet$Water_Year)

(Monthly_Relative_Storage_Dry_Avg_Wet_Plot = ggplot(MODFLOW_Budget_Relative_Storage_Dry_Avg_Wet, aes(x = Month, y = Relative_Storage_m3/1E6)) + 
...
# Selected Water Budget Fluxes - Dry, Avg, Wet Years (Mm3)----------------------------

fig_name = 'Selected Fluxes_Wet_Avg_Dry_Mm3'
if (fig_format == 'jpg'){
...
vplayout <- function(x, y) viewport(layout.pos.row = x, layout.pos.col = y)
print(Monthly_Precip_Dry_Avg_Wet_Plot +
...
if (COMPARE_MAR_BUDGET==TRUE){
  ...
  Water_Budget_MODFLOW_MAR_Annual_Diff = Water_Budget_MODFLOW_MAR_Annual_Plotting - MODFLOW_Annual_m3_Plotting
...
if (COMPARE_ILR_BUDGET==TRUE){
  ...
  Water_Budget_MODFLOW_ILR_Annual_Diff = Water_Budget_MODFLOW_ILR_Annual_Plotting - MODFLOW_Annual_m3_Plotting
...
if (COMPARE_MAR_ILR_BUDGET==TRUE){
  ...
  Water_Budget_MODFLOW_MAR_ILR_Annual_Diff = Water_Budget_MODFLOW_MAR_ILR_Annual_Plotting - MODFLOW_Annual_m3_Plotting
...
print(Monthly_Recharge_Dry_Avg_Wet_Plot_TAF +
        theme(legend.position = 'none',
              ...
              axis.title.y = element_text(size = 10),
              axis.text.x = element_blank(),
              plot.margin =  margin(t=-8,b=-8,l=8,r=8)), vp = vplayout(2,1))
print(Monthly_Pumping_Dry_Avg_Wet_Plot_TAF +
        theme(legend.position = 'none',
              plot.title = element_text(hjust = 0.02, vjust = -6, size = 8),
              axis.title.y = element_text(size = 10),
              axis.text.x = element_text(size = 8),
              plot.margin =  margin(t=-8,b=-8,l=8,r=8)), vp = vplayout(3,1))
print(Monthly_GW_SW_Flux_Dry_Avg_Wet_Plot_TAF +
        theme(legend.position = 'none',
              plot.title = element_text(hjust = 0.02, vjust = -6, size = 8),
              axis.title.y = element_text(size = 10),
              axis.text.x = element_blank(),
              plot.margin =  margin(t=-8,b=-8,l=8,r=8)), vp = vplayout(1,2))
print(Monthly_Relative_Storage_Dry_Avg_Wet_Plot_TAF +
        theme(legend.position = 'none',
              plot.title = element_text(hjust = 0.02, vjust = -6, size = 8),
              axis.title.y = element_text(size = 10),
              axis.text.x = element_text(size = 8),
              plot.margin =  margin(t=-8,b=-18,l=8,r=8)), vp = vplayout(2,2))
graphics.off()
