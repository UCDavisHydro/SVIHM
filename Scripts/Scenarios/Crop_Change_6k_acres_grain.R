...
# Scenario Settings -----------------------------------------------------
scen <- list(
  'name'             = 'grain_6k',    # Scenario name, will be part of directory name
  ...
  'grain_from_alf_acres' = 3000,       # Target acreage to convert from basecase-alfalfa to permanent grain
  'grain_from_pas_acres' = 2000        # Target acreage to convert from basecase-pasture to permanent grain
)
