...
scen <- list(
  ...
  'grain_from_alf_acres' = 6000,       # Target acreage to convert from basecase-alfalfa to permanent grain
  'grain_from_pas_acres' = 4000       # Target acreage to convert from basecase-pasture to permanent grain
)
