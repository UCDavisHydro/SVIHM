...
write_SWBM_main_input_file(output_dir = working_dir,
                           ...
                           et_segments_file='et_segments_low.txt',
...
file.copy(from=file.path(data_dir['ref_data_dir','loc'],'et_segments_low.txt'), to=working_dir, overwrite=T)
...
write_scen_prep_batchfile(scen_dir = working_dir, scenario_name = scen$name, et_seg_file='et_segments_low.txt')
