...
# Scenario Settings -----------------------------------------------------
scen <- list(
  'name'             = 'irr_eff_0.1',    # Scenario name, will be part of directory name
  ...
  'irr_eff_change'   = 0.1             # Blanket increase (or decrease) in irrigation efficiency
)
# ------------------------------------------------------------------------------------------------#

# Scenario Processing -------------------------------------------------------------------------

# Create default items to scen related to scen$type
