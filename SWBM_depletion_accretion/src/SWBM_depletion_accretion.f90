...
! Water source dry or sub or n* (555) with any irrig type -> et/noIRR
  ...
  INTEGER  :: WELL_LAY, WELL_ROW, WELL_COL        ! location of cells for streamflow depletion/accretion
  REAL  :: PMP_RCH_RATE                           ! Rate for pumping or recharge
  ...
  read(10,*) WELL_LAY, WELL_ROW, WELL_COL, PMP_RCH_RATE
  close(10)
  
  if (PMP_RCH_RATE .LT. 0) then
    write(*,*)'Streamflow depletion analysis is active'
    write(*,'(A15, F8.2, A8)') 'Pumping Rate = ',PMP_RCH_RATE, ' m^3/day'
    ...
    write(800,'(A15, F8.2, A8)') 'Pumping Rate = ',PMP_RCH_RATE, ' m^3/day'
    write(800,'(A16,I1,A5,I3,A5,I3)') 'Location: Layer ',WELL_LAY, ' Row ', WELL_ROW, 'Col ', WELL_COL
  else if (PMP_RCH_RATE .GT. 0) then
  	write(*,*)'Streamflow accretion analysis is active'
    write(*,'(A15, F8.2, A8)') 'Recharge Rate = ',PMP_RCH_RATE, ' m^3/day'
    write(*,'(A16,I1,A5,I3,A5,I3)') 'Location: Layer ',WELL_LAY, ' Row ', WELL_ROW, 'Col ', WELL_COL
    write(800,*)'Streamflow depletion analysis is active'
    write(800,'(A15, F8.2, A8)') 'Recharge Rate = ',PMP_RCH_RATE, ' m^3/day'
    write(800,'(A16,I1,A5,I3,A5,I3)') 'Location: Layer ',WELL_LAY, ' Row ', WELL_ROW, 'Col ', WELL_COL
  else
    write(*,*)'Basecase conditions (no additional pumping/recharge)'
    write(800,*)'Basecase conditions (no additional pumping/recharge)'                   
  end if
  ...
  write(117,*)'Stress_Period Precip SW_Irr GW_Irr ET Recharge Storage'
   ...
   do im=1, nmonth            ! Loop over each month
     ...
     do jday=1, nday(imonth)                         ! Loop over days in each month
       ...
       call write_MODFLOW_RCH(im,imonth,nday,nrows,ncols,output_zone_matrix) 
       ...
       call write_MODFLOW_WEL(im,imonth,total_n_wells,n_wel_param,WELL_LAY, WELL_ROW, WELL_COL,PMP_RCH_RATE)    
